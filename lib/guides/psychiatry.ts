...
export const psychiatry: GuideData = {
  ...
  fit: {
    ...
    ctaLabel: 'Get Step Gunner free, psychiatry decks included',
  ...
  endPrimaryLabel: 'Get the free psychiatry deck',
  ...
  sticky: {
    label: 'Free Psych decks. No sign-up.',
    cta: 'Get the app',
  },
  navCta: 'Get the free Psych deck',
};
